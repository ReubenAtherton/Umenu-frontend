    ...
    return (
        <View style={style.container}>
            <TouchableOpacity
                style={[
                    style.inactiveTab,
                    activeTab === 'Menu' && style.activeTab
                ]}
                onPress={() => { setActiveTab('Menu') }}>
                <View style={{ flexDirection: 'row' }}>
                    <MaterialIcons name="menu-book" size={17} color="black" style={[
                        style.inactiveIcon,
            ...
            <TouchableOpacity
                style={[
                    style.inactiveTab,
                    activeTab === 'Reviews' && style.activeTab
                ]}
                onPress={() => { setActiveTab('Reviews') }}>
                <View style={{ flexDirection: 'row' }}>

                    <MaterialIcons name="reviews" size={17} color="black" style={[
                        style.inactiveIcon,
